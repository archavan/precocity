...
body_mass_comparison <- ggplot(
  ptmv,
  aes(adult_body_mass_g_pt, adult_body_mass_g_mv, label = binomial)
) +
...
gestation_comparison <- ggplot(
  ptmv,
  aes(gestation_len_d_pt, gestation_len_d_mv, label = binomial)
) +
  geom_point(alpha = 0.75) +
  scale_x_log10() +
  scale_y_log10() +
