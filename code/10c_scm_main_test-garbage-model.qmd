...
If the likelihood value of our Mk model is the same as the likelihood value of the garbage model, we have lost historical information. Ideally, our Mk model should have a high likelihood. 
...
model_weights <- read_rds(here(resdir, "consensus/model-fit.rds"))
```
