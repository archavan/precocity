...
clades$family[[which(clades$rank08 == "Vermilingua")]] <- get_families(
  "Vermilingua"
)
clades$family[[which(clades$rank08 == "Folivora")]] <- get_families("Folivora")
clades$family[[which(clades$rank08 == "Caniformia")]] <- get_families(
  "Caniformia"
)
clades$family[[which(clades$rank08 == "Feliformia")]] <- get_families(
  "Feliformia"
)
clades$family[[which(clades$rank08 == "Castorimorpha")]] <- get_families(
  "Castorimorpha"
)
clades$family[[which(clades$rank08 == "Myomorpha")]] <- get_families(
  "Myomorpha"
)
clades$family[[which(clades$rank08 == "Anomaluromorpha")]] <- get_families(
  "Anomaluromorpha"
)
clades$family[[which(clades$rank08 == "Hystricomorpha")]] <- get_families(
  "Hystricomorpha"
)
clades$family[[which(clades$rank08 == "Sciuromorpha")]] <- get_families(
  "Sciuromorpha"
)
...
clades$family[[which(clades$rank08 == "Yangochiroptera")]] <- c(
  "Emballonuridae",
  "Furipteridae",
  "Miniopteridae",
  "Molossidae",
...
clades$family[[which(clades$rank08 == "Yinpterochiroptera")]] <- c(
  "Craseonycteridae",
  "Hipposideridae",
  "Megadermatidae",
  "Pteropodidae",
