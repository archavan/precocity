...
# Prototheria has only 1 species in this dataset
...
# Xenarthra has only 1 species in this dataset
...
arc.cladelabels(
  ...
  node = getMRCA(
    ...
    c(
      ...
      # Erinaceidae, Solenodontidae, Talpidae not in data
    )
  ),
  ln.offset = 1.06,
  lab.offset = 1.08,
...
arc.cladelabels(
  ...
  node = getMRCA(
    ...
    c(
      ...
      get_species_in_taxon("Hyaenidae", taxa) # Eupleridae not in data
    )
  ),
  ln.offset = 1.02,
  lab.offset = 1.04,
...
# families
# Felidae has only 1 species in this dataset
...
arc.cladelabels(
  ...
  node = getMRCA(
    ...
    c(
      ...
      # Cuniculidae, Dasyproctidae, Dinomyidae, Ctenomyidae, Octodontidae,
      # Abrocomidae, Chinchillidae, Capromyidae, Myocastoridae not in data
    )
  ),
  ln.offset = 1.02,
  lab.offset = 1.04,
