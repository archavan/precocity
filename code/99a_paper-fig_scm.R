...
cairo_pdf(here(figdir, "fig_scm_a_consensus-asr.pdf"), 
          width = 13.5, 
          height = 7.5, 
...
png(here(figdir, "fig_scm_a_consensus-asr.png"), 
    width = 13.5, 
    height = 7.5, 
    units = "in",
    res = 600,
...
asr_png <- png::readPNG(here(figdir, "fig_scm_a_consensus-asr.png"), 
                        native = TRUE)
...
ggsave(here(figdir, "fig_scm_composed_v1.png"), 
       composed, 
       width = 6.5, 
       height = 5, 
       units = "in",
...
ggsave(here(figdir, "fig_scm_composed_v1.pdf"), 
       composed, 
       width = 6.5, 
       height = 5, 
       units = "in",
